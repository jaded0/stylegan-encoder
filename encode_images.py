...
def main():
    ...
    parser.add_argument('--model_url', default='https://osf.io/tgpu7/download', help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl
